...
class CustomCancelledCard extends StatefulWidget {
  @override
  State<CustomCancelledCard> createState() => _CustomCancelledCardState();
}

class _CustomCancelledCardState extends State<CustomCancelledCard> {
  @override
