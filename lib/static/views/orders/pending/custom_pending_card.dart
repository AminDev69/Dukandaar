...
class CustomPendingCard extends StatefulWidget {
  // DistributorModel distributorModel;

  // CustomPendingCard({this.distributorModel});

  @override
  State<CustomPendingCard> createState() => _CustomPendingCardState();
}

class _CustomPendingCardState extends State<CustomPendingCard> {
